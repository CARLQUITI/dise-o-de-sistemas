...
#Este falla porque el objeto está siendo tomado como una variable global dentro de test_singleton.py entonces al modificarse, una y otra vez cambia según la ultima
